...
public interface IBankCardService
{
    ...
    Task<Result<string>> DeactivateBankCardAsync(string cardNumber, string userId, CancellationToken cancellationToken = default);
    Task<Result<string>> ActivateBankCardAsync(string cardNumber, string userId, CancellationToken cancellationToken = default);
}